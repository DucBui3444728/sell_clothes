    ...
    return (
        <div className="group bg-white rounded-2xl overflow-hidden border border-slate-100 shadow-sm hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
            <div className="relative aspect-[4/5] overflow-hidden bg-slate-100">
                ...
                />
                <button className="absolute top-3 right-3 p-2 bg-white/80 backdrop-blur-sm hover:bg-primary-50 text-slate-400 hover:text-primary-600 rounded-full transition-colors duration-200 opacity-0 group-hover:opacity-100">
